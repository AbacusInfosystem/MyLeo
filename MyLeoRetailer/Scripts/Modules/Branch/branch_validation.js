$(function () {
    $("#frmBranch").validate({
        rules: {
            ...
            //"Branch.Near_Branch_Location_Pincode": { required: true, digits:true },
            //"Branch.Far_Branch_Location_Pincode": { required: true }
        },
        messages: {

            "Branch.Branch_Name": { required: "Branch Name is required." },
            //"Branch.Near_Branch_Location_Pincode": { required: "Near Branch Pincode is required.", digits:"Enter valid pin"},
