    ...
    public class PurchaseReturnController: BaseController
    {
        ...
        public ActionResult Index(PurchaseReturnViewModel prViewModel)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Error("PurchaseReturn Controller - Index : " + ex.ToString());//Added by vinod mane on 06/10/2016
            }
        ...
        public ActionResult Search(PurchaseReturnViewModel prViewModel)
        {
            ...
            {
                prViewModel.FriendlyMessages.Add(MessageStore.Get("SYS01"));
                Logger.Error("PurchaseReturn Controller - Search : " + ex.ToString());//Added by vinod mane on 06/10/2016
            }
        ...
        public PartialViewResult Update_GR_No(int Id)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Error("PurchaseReturn Controller - Update_GR_No : " + ex.ToString());
            }
            //End
        ...
        public JsonResult Get_Purchase_Return_Items_By_SKU_Code(string SKU_Code)
        {
            ...
            catch (Exception ex)
            {
                ...
                prViewModel.FriendlyMessages.Add(MessageStore.Get("SY01"));
                Logger.Error("PurchaseReturn Controller - Get_Purchase_Return_Items_By_SKU_Code : " + ex.ToString());
            }
            //End
        ...
        public JsonResult Get_Purchase_Return_PO_By_POI(int Purchase_Invoice_Id, string SKU_Code)
        {
            ...
            catch (Exception ex)
            {
                ...
                prViewModel.FriendlyMessages.Add(MessageStore.Get("SY01"));
                Logger.Error("PurchaseReturn Controller - Get_Purchase_Return_PO_By_POI : " + ex.ToString());
            }
            //End
            return Json(prViewModel.PurchaseReturn, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult Insert_Purchase_Return(PurchaseReturnViewModel prViewModel)
        {
            ...
            catch (Exception ex)
            {
                ...
                prViewModel.FriendlyMessages.Add(MessageStore.Get("SY01"));
                Logger.Error("PurchaseReturn Controller - Insert_Purchase_Return : " + ex.ToString());//Added by vinod mane on 06/10/2016
            }
        ...
        public JsonResult Update_Purchase_Return(PurchaseReturnViewModel prViewModel)
        {
            ...
            catch (Exception ex)
            {
                ...
                prViewModel.FriendlyMessages.Add(MessageStore.Get("SY01"));
                Logger.Error("PurchaseReturn Controller - Update_Purchase_Return : " + ex.ToString());//Added by vinod mane on 06/10/2016
            }
        ...
        public JsonResult Get_Purchase_Returns(PurchaseReturnViewModel prViewModel)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Error("PurchaseReturn Controller - Get_Purchase_Returns : " + ex.ToString());
            }
        ...
        public JsonResult Get_Purchase_Return_List(PurchaseReturnViewModel prViewModel)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Error("PurchaseReturn Controller - Get_Purchase_Return_Requests : " + ex.ToString());
            }
        ...
        public ActionResult Get_Purchase_Return_Details_By_Id(PurchaseReturnViewModel prViewModel)
        {
            ...
            {
                prViewModel.FriendlyMessages.Add(MessageStore.Get("SYS01"));
                Logger.Error("PurchaseReturn Controller - Get_Purchase_Return_Details_By_Id  " + ex.Message);//Added by vinod mane on 06/10/2016
            }
